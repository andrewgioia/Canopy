...
<div id="wrapper">
    ...
    <header>
        ...
        <menu>
            <a href="/" class="button"><i class="fa fa-tachometer pull-up"></i>Dashboard</a>
            <a href="/" class="button"><i class="fa fa-calendar pull-up"></i>Calendar</a>
            <a href="/" class="button"><i class="fa fa-gear"></i>Settings</a>
        </menu>
    </header>
